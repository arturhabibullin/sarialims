# Generated by Django 3.2.7 on 2021-09-15 08:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='НП, ВП, Mix', max_length=50, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='e.g A, C,F, птичья, мясо-костная', max_length=50, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_line', models.BooleanField(verbose_name='производственная линия')),
                ...
                ('material_type', models.ForeignKey(help_text='e.g мука, жир, шквара', on_delete=django.db.models.deletion.CASCADE, to='lims.materialtype', verbose_name='вид образца')),
                ('product', models.ForeignKey(help_text='e.g A, C, птичья, мясо-костная', on_delete=django.db.models.deletion.CASCADE, to='lims.producttype', verbose_name='продукт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_pub', models.DateTimeField(auto_now=True)),
                ('date_time_result', models.DateTimeField(blank=True, null=True, verbose_name='дата и время результатов')),
