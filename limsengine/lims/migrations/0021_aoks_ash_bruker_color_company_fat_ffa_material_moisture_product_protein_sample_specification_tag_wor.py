...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='e.g линия А, птичья', max_length=50, unique=True)),
                ('slug', models.SlugField(unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(help_text='e.g мука, жир, шквара', on_delete=django.db.models.deletion.CASCADE, to='lims.material', verbose_name='вид образца')),
                ('product', models.ForeignKey(help_text='e.g A, C, птичья, мясо-костная', on_delete=django.db.models.deletion.CASCADE, to='lims.product', verbose_name='продукт')),
                ('tags', models.ManyToManyField(blank=True, related_name='samples', to='lims.Tag', verbose_name='категории, теги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technical_information', models.CharField(blank=True, help_text='для внутреннего использования', max_length=150, verbose_name='тех. инфо')),
