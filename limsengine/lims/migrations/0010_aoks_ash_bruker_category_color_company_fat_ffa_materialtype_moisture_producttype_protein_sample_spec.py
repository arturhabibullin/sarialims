...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.IntegerField(verbose_name='смена')),
            ],
            options={
                'verbose_name': 'Смена',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specification', models.ManyToManyField(blank=True, related_name='samples', to='lims.Specification')),
